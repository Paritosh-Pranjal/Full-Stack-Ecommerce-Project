      ...
      <div className="pt-6">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <Button
                  variant="contained"
                  sx={{ px: "2rem", py: "1rem", backgroundColor: "#9155fd" }}
                >
                  Add to Cart
                </Button>
              </form>
        ...
        <section>
          ...
          <div className="border p-5">
            <Grid2 container spacing={8} justifyContent={"space-between"}>
              <Grid2 item xs={7}>
                ...
                <Box className="mt-5">
                  ...
                  <div className="flex items-center ">
                    ...
                    <div className="flex-1">
                      <div className="w-full bg-gray-200 rounded h-2">
                        <div
                          className="h-full bg-lime-500 rounded transition-all duration-300 ease-in-out"
                          style={{ width: "30%" }}
                        />
                      </div>
                    </div>
                  ...
                  <div className="flex items-center ">
                    ...
                    <div className="flex-1">
                      <div className="w-full bg-gray-200 rounded h-2">
                        <div
                          className="h-full bg-orange-500 rounded transition-all duration-300 ease-in-out"
                          style={{ width: "20%" }}
                        />
                      </div>
                    </div>
